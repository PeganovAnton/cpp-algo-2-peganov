...
* Реализуйте функцию `list_insert(List<DataType> & l, int i, const DataType &value)`, вставляющую элемент в `i` позицию списка. Вставьте значение -1 в серидину списка.
